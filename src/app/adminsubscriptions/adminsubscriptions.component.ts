...
@Component({
  ...
  templateUrl: './adminsubscriptions.component.html',
  styleUrls: ['./adminsubscriptions.component.css']
})
export class AdminsubscriptionsComponent implements OnInit {
  ...
  fileNameDialogRef: MatDialogRef<NewSubscriptionComponent>;
  ...
  openAddFileDialog() {
    this.fileNameDialogRef = this.dialog.open(NewSubscriptionComponent);
  }
