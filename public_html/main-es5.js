...
module.exports = "<h2 mat-dialog-title>Charts\n    <button mat-dialog-close class=\"close\">\n        <span aria-hidden=\"true\">×</span>\n    </button>\n</h2>\n<iframe src=\"https://forex.echofin.co/js/templates/tradingview-container.html\" style=\"    width: 650px;\nheight: 400px;\"></iframe>"
...
module.exports = "<h2 mat-dialog-title>COIN 360\n    <button mat-dialog-close class=\"close\">\n        <span aria-hidden=\"true\">×</span>\n    </button>\n</h2>\n<iframe src=\"https://coin360.io/\" style=\"    width: 880px;\nheight: 608px;\"></iframe>"
...
module.exports = "<h2 mat-dialog-title>Market Hours\n    <button mat-dialog-close class=\"close\">\n        <span aria-hidden=\"true\">×</span>\n    </button>\n</h2>\n<iframe src=\"https://tradetools.tk/s/markethours/\" style=\"    width: 738px;\nheight: 291px;\"></iframe>"
...
var AdminbillingComponent = /** @class */ (function () {
    ...
    // filter
    AdminbillingComponent.prototype.onActiveFilter = function () {
...
var AdmincomplianceComponent = /** @class */ (function () {
    function AdmincomplianceComponent() {
        this.mode = 'determinate';
        this.showSpinner = false;
...
var AdmincontactsComponent = /** @class */ (function () {
    function AdmincontactsComponent(dialog, contactsService) {
        this.dialog = dialog;
    ...
    // onrefresh
    AdmincontactsComponent.prototype.onRefresh = function () {
        var _this = this;
        this.showSpinner = true;
        this.mode = 'indeterminate';
        setTimeout(function () {
    ...
    // filter
    AdmincontactsComponent.prototype.onActiveFilter = function () {
        this.filterActive = !this.filterActive;
    };
...
var AdmincouponsComponent = /** @class */ (function () {
    function AdmincouponsComponent(dialog, couponService) {
        this.dialog = dialog;
    ...
    // filter
    AdmincouponsComponent.prototype.onActiveFilter = function () {
        this.filterActive = !this.filterActive;
    };
...
var AdminoffersComponent = /** @class */ (function () {
    ...
    // filter
    AdminoffersComponent.prototype.onActiveFilter = function () {
        this.filterActive = !this.filterActive;
    };
...
var AdminsalesComponent = /** @class */ (function () {
    ...
    // filter
    AdminsalesComponent.prototype.onActiveFilter = function () {
        this.filterActive = !this.filterActive;
    };
...
var AdminservicesComponent = /** @class */ (function () {
    function AdminservicesComponent(dialog, serviceService) {
        this.dialog = dialog;
...
var AdminsettingsComponent = /** @class */ (function () {
    function AdminsettingsComponent(dialog) {
        this.dialog = dialog;
...
var NewTeamAvatarComponent = /** @class */ (function () {
    function NewTeamAvatarComponent() {
    }
...
var AdminwidgetComponent = /** @class */ (function () {
    function AdminwidgetComponent(dialog) {
        this.dialog = dialog;
        this.version = _angular_material__WEBPACK_IMPORTED_MODULE_2__["VERSION"];
    }
...
var ConfiguredialogComponent = /** @class */ (function () {
    function ConfiguredialogComponent() {
...
/* harmony import */ var mat_table_exporter__WEBPACK_IMPORTED_MODULE_59__ = __webpack_require__(/*! mat-table-exporter */ "./node_modules/mat-table-exporter/fesm5/mat-table-exporter.js");
...
/*!**************************************************!*\
  !*** ./src/app/dashboard/dashboard.component.ts ***!
  \**************************************************/
/*! exports provided: DashboardComponent, ChartsDialog, MarketHoursDialog, FXHeatmapDialog, Coin360Dialog */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(socketService, user, userService, dialog) {
        var _this = this;
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(auth, user, router) {
        this.auth = auth;
        this.user = user;
        this.router = router;
...
var User = /** @class */ (function () {
    ...
    User.prototype.setLoginUser = function (user) {
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.initlializeUser = function (user) {
...
module.exports = "/* preferences dialog */\nmat-form-field{\n  width: 100%;\n}\n.modal-footer{\n  border-top: 1px solid #ddd;\n}\nmat-checkbox{\n  width: 100%;\n  display: block;\n}\n.rooms-overflow {\n  padding: 0px 30px;\n    height: 196px;\n    overflow-y: auto;\n    margin: 10px 0;\n}\n.blockandmute-body {\n  border: 1px solid #ddd;\n  padding: 10px;\n  margin: 10px 0;\n}\n.blockandmute-body button{\n  color: #fff!important;;\n}\n.blockandmute-body .label{\n  margin-right: 5px;\n}\n.empty-msg{\n  padding: 5px 0 15px;\n  text-align: left;\n  font-size: 1.1rem;\n  color: #666;\n}\n.form-group label {\n  font-weight: bold;\n}\n.blockandmute-title{\n font-weight: bold;\n}\n.preference-container .active{\n  border-left: 2px solid #0C2124!important;\n  background-color: #e26727!important;\n  color: #fff!important;\n}\n.preference-container .content{\n  background: #fff;\n  padding: 10px!important;\n  border-top: 1px solid #ddd;\n}\n.preference-container > .row{\n  display: -webkit-box;\n  display: flex;\n}\n.preference-container > .row .col-md-3{\n  -webkit-box-flex: 1;\n          flex: auto 0;\n  background: #eee;\n}\n.preference-container > .row .col-md-9{\n  -webkit-box-flex: 1;\n          flex: auto 0;\n}\n.preference-container .upload_file{\n position: relative;\n}\n.preference-container .content.profile .btn{\n  width: 100%;\n}\n.preference-container .upload_file input{\n  position: absolute;\n  height: 100%;\n  width: 100%;\n  opacity: 0;\n  z-index: 1;\n  line-height: 38px;\n  cursor: pointer;\n }\n/*# sourceMappingURL=data:application/json;base64, */"
...
/*!**********************************************!*\
  !*** ./src/app/sidenav/sidenav.component.ts ***!
  \**********************************************/
/*! exports provided: SidenavComponent, PreferencesDialog */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var SidenavComponent = /** @class */ (function () {
    function SidenavComponent(userService, authService, socketService, dialog) {
        this.socketService = socketService;
        this.dialog = dialog;
...
module.exports = ".wrap_messages{\n  position:absolute;\n  width:100%;\n  top:10px;\n  bottom:10px;  \n  height: calc(100vh - 140px);\n}\n.message_list{\n  position:absolute;\n    bottom:0px;\n    right:0px;\n    left:0px;\n    overflow-y:auto;\n    max-height:100%;\n}\nform{\n  position: absolute;\nheight: 0px;\nbottom: 0;\nwidth: 99%;\n}\n.wrap_messages .msg_delivered:last-child {\n  padding-bottom: 15px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var UnlockchatroomComponent = /** @class */ (function () {
    function UnlockchatroomComponent(socketService, userService) {
        this.socketService = socketService;
        this.messages = [];
        this.selectedRoom = {
            _id: String
