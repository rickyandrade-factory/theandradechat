...
var AdminbillingComponent = /** @class */ (function () {
    function AdminbillingComponent(dialog) {
        this.dialog = dialog;
...
var AdminchatroomComponent = /** @class */ (function () {
    function AdminchatroomComponent(dialog, auth) {
        this.dialog = dialog;
        this.auth = auth;
...
var AdmincouponsComponent = /** @class */ (function () {
    function AdmincouponsComponent(dialog) {
        this.dialog = dialog;
...
// })
var AdminpaymentsComponent = /** @class */ (function () {
    ...
    AdminpaymentsComponent.prototype.ngOnInit = function () {
        this.dataSource.paginator = this.paginator;
        this.dataSource.sort = this.sort;
    };
    AdminpaymentsComponent.prototype.applyFilter = function (filterValue) {
        this.dataSource.filter = filterValue.trim().toLowerCase();
        if (this.dataSource.paginator) {
            this.dataSource.paginator.firstPage();
        }
...
var AdminpayoutsComponent = /** @class */ (function () {
    function AdminpayoutsComponent(dialog) {
        this.dialog = dialog;
    ...
    AdminpayoutsComponent.prototype.openAddFileDialog = function () {
        this.fileNameDialogRef = this.dialog.open(_withdraw_option_component__WEBPACK_IMPORTED_MODULE_6__["WithdrawOptionComponent"]);
    };
    AdminpayoutsComponent.prototype.openpayment = function () {
        this.fileNameDialogRef = this.dialog.open(_view_payment_component__WEBPACK_IMPORTED_MODULE_7__["ViewPaymentComponent"]);
    };
    AdminpayoutsComponent.prototype.ngOnInit = function () {
        this.dataSource.paginator = this.paginator;
        this.dataSource.sort = this.sort;
    };
    AdminpayoutsComponent.prototype.applyFilter = function (filterValue) {
        this.dataSource.filter = filterValue.trim().toLowerCase();
        if (this.dataSource.paginator) {
            this.dataSource.paginator.firstPage();
        }
    };
    AdminpayoutsComponent.ctorParameters = function () { return [
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_5__["MatDialog"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material_paginator__WEBPACK_IMPORTED_MODULE_2__["MatPaginator"], { static: true })
...
var WithdrawOptionComponent = /** @class */ (function () {
    function WithdrawOptionComponent() {
        this.paymethod = 'option1';
        this.selectedcycle = 'weekly';
    }
    ...
    return WithdrawOptionComponent;
}());
...
var AdminservicesComponent = /** @class */ (function () {
    function AdminservicesComponent(dialog) {
        this.dialog = dialog;
...
var AdminsubscriptionsComponent = /** @class */ (function () {
    function AdminsubscriptionsComponent(dialog) {
        this.dialog = dialog;
    ...
    AdminsubscriptionsComponent.prototype.openAddFileDialog = function () {
    ...
    AdminsubscriptionsComponent.prototype.ngOnInit = function () {
        this.dataSource.paginator = this.paginator;
        this.dataSource.sort = this.sort;
    };
    AdminsubscriptionsComponent.prototype.applyFilter = function (filterValue) {
        this.dataSource.filter = filterValue.trim().toLowerCase();
        if (this.dataSource.paginator) {
            this.dataSource.paginator.firstPage();
        }
    };
    AdminsubscriptionsComponent.ctorParameters = function () { return [
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_5__["MatDialog"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material_paginator__WEBPACK_IMPORTED_MODULE_2__["MatPaginator"], { static: true })
    ...
    return AdminsubscriptionsComponent;
}());
...
var NewSubscriptionComponent = /** @class */ (function () {
    function NewSubscriptionComponent() {
    }
...
var AdminusersComponent = /** @class */ (function () {
    function AdminusersComponent(dialog) {
        this.dialog = dialog;
    ...
    AdminusersComponent.prototype.openAddFileDialog = function () {
...
module.exports = ".wrap_messages{\n  /* display: inline-flex; */\n  -webkit-box-pack: end;\n          justify-content: flex-end;\n  -webkit-box-orient: vertical;\n  -webkit-box-direction: normal;\n          flex-direction: column;\n  width: 100%;\n  height: calc(100vh - 120px);\n  overflow-y: scroll!important;\n  vertical-align: top;\n  display: -webkit-box;\n}\n.wrap_messages .msg_delivered:last-child {\n  padding-bottom: 15px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
